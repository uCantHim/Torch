...
#include "material_utils/shadow.glsl"

#define lightBuffer      $lightBufferName
#define lights           (lightBuffer.lights)
#define numSunLights     (lightBuffer.numSunLights)
#define numPointLights   (lightBuffer.numPointLights)
#define numAmbientLights (lightBuffer.numAmbientLights)
