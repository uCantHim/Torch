...
auto trc::makeTriangleGeo() -> GeometryData
{
    return {
        .vertices={
            MeshVertex{ { -0.5f, -0.5f, 0.0f }, { 0, 0, 1 }, { 0.0f, 0.0f }, { 1, 0, 0 } },
            MeshVertex{ {  0.5f, -0.5f, 0.0f }, { 0, 0, 1 }, { 1.0f, 0.0f }, { 1, 0, 0 } },
            MeshVertex{ {  0.0f,  0.5f, 0.0f }, { 0, 0, 1 }, { 0.5f, 1.0f }, { 1, 0, 0 } },
        },
        .skeletalVertices={},
        .indices={ 0, 1, 2 }
    };
